    ...
    <section id="packages" className="relative overflow-hidden py-14">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          description="Premium preventive care packages for individuals, families and organizations."
        />
        <motion.div
              ...
              <Tilt3D intensity={9} className="h-full">
                ...
                >
                  ...
                  <ul className="mt-6 flex-1 space-y-3">
                    {p.features.map((f) => (
                      <li key={f} className="flex items-start gap-2 text-sm">
                        <Check size={17} className={cn("mt-0.5 shrink-0", p.featured ? "text-white" : "text-mint")} />
                  ...
                  <Link
                    href="/appointment"
                    className={cn(
                      "mt-7 block w-full rounded-xl py-2.5 text-center text-sm font-bold transition",
                      p.featured
